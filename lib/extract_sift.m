...
% run('~/Documents/MATLAB/vlfeat-0.9.20/toolbox/vl_setup') before run the
% code below
...
if ~exist(conf.vocabPath)
  ...
  %cat by column cat(2,)
  % subsample features descriptor if having limited computational resource
  [descrsSelected, sel_ind] = vl_colsubset(cat(2, descrs{:}), 50000); 
